...
class ContactsViewController: UIViewController, UITableViewDataSource, UITableViewDelegate {
    ...
    func setUpContacts()
    {
        ...
        //Start of Residence Front Desk Hours
        var contact45 = Contacts (name: "Adelaide Hall Front Desk",             number: "1-613-533-3183")
        var contact46 = Contacts (name: "Ban Righ Hall Front Desk",             number: "1-613-533-3183")
        var contact47 = Contacts (name: "Brockington House Front Desk",         number: "1-613-533-3183")
        var contact48 = Contacts (name: "Chown Hall Front Desk",                number: "1-613-533-3183")
        var contact49 = Contacts (name: "Gordon House Front Desk",              number: "1-613-533-3183")
        var contact50 = Contacts (name: "Graduate Residence Front Desk",        number: "1-613-533-2531")
        var contact51 = Contacts (name: "Harkness Hall Front Desk",             number: "1-613-533-2531")
        var contact52 = Contacts (name: "Jean Royce Hall Front Desk",           number: "1-613-533-2551")
        var contact53 = Contacts (name: "Leggett Hall Front Desk",              number: "1-613-533-3183")
        var contact54 = Contacts (name: "Leonard Hall Front Desk",              number: "1-613-533-3183")
        var contact55 = Contacts (name: "McNeill House Front Desk",             number: "1-613-533-3183")
        var contact56 = Contacts (name: "Morris Hall Front Desk",               number: "1-613-533-3183")
        var contact57 = Contacts (name: "Victoria Hall Front Desk",             number: "1-613-533-2531")
        var contact58 = Contacts (name: "Waldron Tower Front Desk",             number: "1-613-533-6724")
        var contact59 = Contacts (name: "Watts Hall Front Desk",                number: "1-613-533-3183")
