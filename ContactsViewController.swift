...
class ContactsViewController: UIViewController, UITableViewDataSource, UITableViewDelegate {
    ...
    func setUpContacts()
    {
        ...
        var contact4 = Contacts (name: "AMS Peer Support Centre", number: "1-613-533-6000 ext- 75111")
        var contact5 = Contacts (name: "Campus Observation Room", number: "1-613-533-6911")
        var contact6 = Contacts (name: "Frontenac Community Mental Health Services ", number: "1-613-544-4229")
        var contact7 = Contacts (name: "Good2Talk", number: "1-1-866-925-5454")
        var contact8 = Contacts (name: "Lesbian, Gay, Bi and Transgender Youth Line", number: "1-800-268-9688")
        ...
        var contact14 = Contacts (name: "Campus Security and Emergency Services (Inquiries)", number: "1-613-533-6733")
        ...
        var contact17 = Contacts (name: "Health, Counselling and Disability Services (HCDS)", number: "1-613-533-2506")
        var contact18 = Contacts (name: "Human Rights Office", number: "1-613-533-6886")
        var contact19 = Contacts (name: "Queen’s University International Centre (QUIC)", number: "1-613-533-2604")
        var contact20 = Contacts (name: "Queen’s Sexual Health Resource Centre", number: "1-613-533-2959")
        var contact21 = Contacts (name: "Sexual Assault and Intimate Partner Violence Counselling", number: "1-613-533-6000 ext- 78441")
        var contact22 = Contacts (name: "Student Academic Success Services (SASS): Learning Strategies and The Writing Centre", number: "1-613-533-6315")
        var contact23 = Contacts (name: "Student Awards Office (OSAP)", number: "1-613-533-2216")
        var contact24 = Contacts (name: "Society for Graduate and Professional Students (SGPS)/ Student Advisor Program", number: "1-613-533-3169")
        ...
        var contact28 = Contacts (name: "Crisis Counselling", number: "1-613-533-6000 ext- 78264")
        ...
        var contact33 = Contacts (name: "Alumni Review Magazine", number: "1-613-533-6000 ext 75464")
        ...
        var contact38 = Contacts (name: "Residence Admissions (admissions, fees, room assignments)", number: "1-613-533-2550")
        var contact39 = Contacts (name: "Residence Life Office (general questions/concerns)", number: "1-613-533-6790")
        var contact40 = Contacts (name: "Facilities Control Centre (building maintenance, damages", number: "1-613-533-3155")
        ...
        arrayOfContacts.append(contact14)
